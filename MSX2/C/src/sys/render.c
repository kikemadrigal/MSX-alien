...
void sys_render_update_object(TEntity *object){
    ...
    if (object->type==entity_type_object_oxigen) PutSprite(object->plane,object_oxigen_pattern,object->x,object->y,0);
    else if (object->type==entity_type_object_batery) PutSprite(object->plane,object_batery_pattern,object->x,object->y,0);
}
...
void sys_render_update_boss(TEntity *entity){
    if(man_game_get_world()==0){
        ...
        HMMM(120,256+24,entity->x,entity->y,24,24); 
